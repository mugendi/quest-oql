...
class Helper {
    ...
    async __parse_fields_arr(fields, type = 'aggregation') {
        ...
        for (let fieldArr of arrify(fields)) {
            ...
            // format field names
            fieldStr = await this.__format_col_names(fieldName.toString());
            ...
            // if has param
            if (param && type == 'aggregation') fieldStr = `${fieldStr} as ${SqlString.escape(param)}`
